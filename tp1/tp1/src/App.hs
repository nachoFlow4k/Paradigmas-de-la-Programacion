...
-- Histograma 1.0097816 0.36261657 [2464,2892,5119,8148,11127,13205,14214,13241,10983,7954,5134,2974,2545]

-- >>> conGenNormal (probarHistograma (1, 5) 100)
-- Histograma 1.244893 0.35478666 [3,2,4,12,10,9,15,15,12,7,7,2,2]
